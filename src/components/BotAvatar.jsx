...
export default function BotAvatar({ enableEyeTracking = false, compact = false }) {
  const [eyePosition, setEyePosition] = useState({ x: 50, y: 50 });
  const avatarRef = useRef(null);

  const { getActivityStatus, startHealthChecks, stopHealthChecks } = useBotStore();
  ...
  if (compact) {
    return (
      <div className="px-2 pt-6 pb-2 flex items-center justify-center">
        <style>{`
          /* Same keyframes as full version */
          ...
          <div
            className={classNames(
              ...
              activityStatus === 'Offline'
                ? 'border-red-500 ring-heartbeat-offline'
                : activityStatus === 'Working'
                  ? 'border-yellow-500 ring-heartbeat-working'
                  : 'border-green-500 ring-heartbeat-idle',
            )}
          >
            {/* Compact Bot Face SVG */}
            <svg
              viewBox="0 0 100 100"
              className={classNames(
                'w-7 h-7',
            ...
            >
              ...
              {/* Mouth */}
              <path d="M40 60 L60 60" stroke="#1f2937" strokeWidth="2" strokeLinecap="round" />
              ...
              {activityStatus === 'Working' && (
                <>
                  <g>
                    ...
                    <path d="M22 40 Q18 52 25 58" stroke="#eab308" strokeWidth="1.5" fill="none" />
  ...
  return (
    <div className="border-b border-dark-800 px-5 py-5">
      ...
      <div className="flex flex-col items-center">
        <div ref={avatarRef} className="relative w-24 h-24 mb-3">
          {/* Circular border with status color and heartbeat */}
          <div
            className={classNames(
              'absolute inset-0 rounded-full border-2 flex items-center justify-center bg-dark-900 transition-colors duration-300',
            ...
            >
              ...
              {activityStatus === 'Offline' ? (
                <g>
                  ...
                  />
                  {/* Z's for sleeping */}
                  <text x="72" y="35" fill="#9ca3af" fontSize="10" fontWeight="bold" opacity="0.6">
                    Z
                  </text>
                  <text x="78" y="28" fill="#9ca3af" fontSize="8" fontWeight="bold" opacity="0.4">
                    z
                  </text>
                  <text x="82" y="23" fill="#9ca3af" fontSize="6" fontWeight="bold" opacity="0.3">
                    z
                  </text>
                </g>
              ) : activityStatus === 'Working' ? (
