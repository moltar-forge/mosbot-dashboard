                              ...
                              <div className="prose prose-invert prose-sm max-w-none text-dark-200 bg-dark-800 p-4 rounded-lg">
                                <ReactMarkdown
                                  ...
                                  components={{
                                    h1: ({ _node, ...props }) => (
                                      <h1
                                        className="text-2xl font-bold text-dark-100 mt-4 mb-2"
                                        {...props}
                                      />
                                    ),
                                    h2: ({ _node, ...props }) => (
                                      <h2
                                        className="text-xl font-semibold text-dark-100 mt-3 mb-2"
                                        {...props}
                                      />
                                    ),
                                    h3: ({ _node, ...props }) => (
                                      <h3
                                        className="text-lg font-semibold text-dark-100 mt-3 mb-2"
                                        {...props}
                                      />
                                    ),
                                    p: ({ _node, ...props }) => (
                                      <p
                                        className="text-dark-200 mb-2"
                                        {...props}
                                      />
                                    ),
                                    ul: ({ _node, ...props }) => (
                                      <ul
                                        className="list-disc list-inside text-dark-200 mb-2 space-y-1"
                                        {...props}
                                      />
                                    ),
                                    ol: ({ _node, ...props }) => (
                                      <ol
                                        className="list-decimal list-inside text-dark-200 mb-2 space-y-1"
                                        {...props}
                                      />
                                    ),
                                    li: ({ _node, ...props }) => (
                                    ...
                                    code: ({ _node, inline, ...props }) =>
                                      inline ? (
                                        <code
                                          className="bg-dark-900 px-1.5 py-0.5 rounded text-primary-400 text-sm"
                                          {...props}
                                        />
                                      ) : (
                                        <code
                                          className="block bg-dark-900 p-3 rounded text-primary-400 text-sm overflow-x-auto mb-2"
                                          {...props}
                                        />
                                      ),
                                    pre: ({ _node, ...props }) => (
                                      <pre
                                        className="bg-dark-900 p-3 rounded overflow-x-auto mb-2"
                                        {...props}
                                      />
                                    ),
                                    ...
                                    hr: ({ _node, ...props }) => (
                                      <hr
                                        className="border-dark-700 my-4"
                                        {...props}
                                      />
                                    ),
                                    strong: ({ _node, ...props }) => (
                                    ...
                                    em: ({ _node, ...props }) => (
                                      <em
                                        className="italic text-dark-200"
                                        {...props}
                                      />
                                    ),
                                    a: ({ _node, ...props }) => (
                                    ...
                                    table: ({ _node, ...props }) => (
                                      <table
                                        className="w-full border-collapse border border-dark-700 my-4"
                                        {...props}
                                      />
                                    ),
                                    thead: ({ _node, ...props }) => (
                                    ...
                                    th: ({ _node, ...props }) => (
                                      <th
                                        className="border border-dark-700 px-4 py-2 text-left font-semibold text-dark-100 bg-dark-900"
                                        {...props}
                                      />
                                    ),
                                    td: ({ _node, ...props }) => (
                                                            ...
                                                            <ReactMarkdown
                                                              ...
                                                              components={{
                                                                h1: ({
                                                                  ...
                                                                  <h1
                                                                    className="text-sm font-bold text-dark-100 mt-2 mb-1"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                h2: ({
                                                                  ...
                                                                  <h2
                                                                    className="text-xs font-semibold text-dark-100 mt-2 mb-1"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                h3: ({
                                                                  ...
                                                                  <h3
                                                                    className="text-xs font-semibold text-dark-100 mt-1 mb-1"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                p: ({
                                                                  ...
                                                                  <p
                                                                    className="text-xs text-dark-300 mb-1"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                ul: ({
                                                                  ...
                                                                  <ul
                                                                    className="list-disc list-inside text-dark-300 mb-1 space-y-0.5 text-xs"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                ol: ({
                                                                  ...
                                                                  <ol
                                                                    className="list-decimal list-inside text-dark-300 mb-1 space-y-0.5 text-xs"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                li: ({
                                                                ...
                                                                code: ({
                                                                  ...
                                                                  inline ? (
                                                                    <code
                                                                      className="bg-dark-900 px-1 py-0.5 rounded text-primary-400 text-[10px]"
                                                                      {...props}
                                                                    />
                                                                  ) : (
                                                                    <code
                                                                      className="block bg-dark-900 p-2 rounded text-primary-400 text-[10px] overflow-x-auto mb-1"
                                                                      {...props}
                                                                    />
                                                                  ),
                                                                pre: ({
                                                                  ...
                                                                  <pre
                                                                    className="bg-dark-900 p-2 rounded overflow-x-auto mb-1"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                blockquote: ({
                                                                  ...
                                                                  <blockquote
                                                                    className="border-l-2 border-dark-600 pl-2 italic text-dark-400 mb-1 text-xs"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                hr: ({
                                                                  ...
                                                                  <hr
                                                                    className="border-dark-700 my-2"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                strong: ({
                                                                ...
                                                                em: ({
                                                                  ...
                                                                  <em
                                                                    className="italic text-dark-300"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                a: ({
                                                                ...
                                                                table: ({
                                                                  ...
                                                                  <table
                                                                    className="w-full border-collapse border border-dark-700 my-2 text-xs"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                thead: ({
                                                                ...
                                                                th: ({
                                                                  ...
                                                                  <th
                                                                    className="border border-dark-700 px-2 py-1 text-left font-semibold text-dark-100 bg-dark-900 text-[10px]"
                                                                    {...props}
                                                                  />
                                                                ),
                                                                td: ({
                                                                  ...
                                                                  <td
                                                                    className="border border-dark-700 px-2 py-1 text-dark-300 text-[10px]"
                                                                    {...props}
                                                                  />
                                                                ),
                                                              }}
